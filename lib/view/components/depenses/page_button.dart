          ...
          child: Wrap(
            ...
            children: [
              ...
              _buildButton(context, "Ajouter", Icons.add, () {
                setState(() => selectedButton = "Ajouter");
                widget.switchView(DepenseSaver());
              }),
              // _buildButton(context, "Exporter", Icons.file_download, () {}),
              _buildButton(context, "Catégories", Icons.category, () {
                setState(() => selectedButton = "Catégories");
                widget.switchView(DepenseCategorie());
              }),
              _buildButton(context, "Types", Icons.list, () {
                setState(() => selectedButton = "Types");
                widget.switchView(DepenseType());
              }),
              // _buildButton(
              //   context,
              //   "Filtrer",

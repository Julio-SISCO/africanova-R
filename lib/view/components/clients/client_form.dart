...
class ClientForm extends StatefulWidget {
  ...
  const ClientForm({super.key, this.showCancel, this.editableClient});
...
class _ClientFormState extends State<ClientForm> {
  ...
  void _initData() {
    if (widget.editableClient != null) {
      _fullnameController.text = widget.editableClient!.fullname ?? '';
      _contactController.text = widget.editableClient!.contact ?? '';
      _phoneController.text = widget.editableClient!.phone ?? '';
      _emailController.text = widget.editableClient!.email ?? '';
      _adresseController.text = widget.editableClient!.adresse ?? '';
    }
  }
